 ...
 */
public class GroupControlKit implements IKit {
...
//        ARouter.getInstance().build("/harmharm/activity").navigation();
        ARouter.getInstance().build("/control/control").withInt("type", Const.BUSINESS_GROUP).navigation();
    }
